...
// Generated on: Nov 28 2023 12:02:41 PST (Nov 28 2023 20:02:41 UTC)
...
module riscv_arbiter(clk, reset, ic_mem_req_valid, ic_mem_req_ready,
  ...
  wire n_0, n_1, n_2;
  OR2x2_ASAP7_75t_SRAM g77__5526(.A (ic_mem_req_valid), .B
       (dc_mem_req_valid), .Y (mem_req_valid));
  AND2x2_ASAP7_75t_R g78__6783(.A (ic_mem_req_addr[9]), .B
       (ic_mem_req_valid), .Y (mem_req_addr[9]));
  NOR2xp33_ASAP7_75t_SL g101__3680(.A (mem_resp_tag[0]), .B (n_2), .Y
       (ic_mem_resp_valid));
  NOR2xp33_ASAP7_75t_SL g102__1617(.A (n_0), .B (n_2), .Y
       (dc_mem_resp_valid));
  NAND2xp33_ASAP7_75t_SL g103__2802(.A (mem_resp_valid), .B (n_1), .Y
       (n_2));
  NOR4xp25_ASAP7_75t_R g104__1705(.A (mem_resp_tag[1]), .B
       (mem_resp_tag[4]), .C (mem_resp_tag[3]), .D (mem_resp_tag[2]),
       .Y (n_1));
  INVxp67_ASAP7_75t_SL g105(.A (mem_resp_tag[0]), .Y (n_0));
...
module cache_1(clk, reset, cpu_req_valid, cpu_req_ready, cpu_req_addr,
  ...
  wire n_86, sram_mem_web_0, sram_mem_web_1, tag_cpu_web;
  ...
  SRAM2RW16x32 CACHE_DATA_BANK_0_0(.A1 ({logic_0_179_net,
       ...
       logic_0_180_net}), .CE1 (n_86), .CE2 (clk), .CSB1
  ...
  SRAM2RW16x32 CACHE_DATA_BANK_0_1(.A1 ({logic_0_191_net,
       ...
       logic_0_192_net}), .CE1 (n_86), .CE2 (clk), .CSB1
  ...
  SRAM2RW16x32 CACHE_DATA_BANK_0_2(.A1 ({logic_0_203_net,
       ...
       logic_0_204_net}), .CE1 (n_86), .CE2 (clk), .CSB1
  ...
  SRAM2RW16x32 CACHE_DATA_BANK_0_3(.A1 ({logic_0_215_net,
       ...
       logic_0_216_net}), .CE1 (n_86), .CE2 (clk), .CSB1
  ...
  SRAM2RW16x32 CACHE_DATA_BANK_1_0(.A1 ({logic_0_227_net,
       ...
       logic_0_228_net}), .CE1 (n_86), .CE2 (clk), .CSB1
  ...
  SRAM2RW16x32 CACHE_DATA_BANK_1_1(.A1 ({logic_0_239_net,
       ...
       ({logic_0_243_net, logic_0_242_net, logic_0_241_net,
       logic_0_240_net}), .CE1 (n_86), .CE2 (clk), .CSB1
  ...
  SRAM2RW16x32 CACHE_DATA_BANK_1_2(.A1 ({logic_0_251_net,
       ...
       logic_0_252_net}), .CE1 (n_86), .CE2 (clk), .CSB1
  ...
  SRAM2RW16x32 CACHE_DATA_BANK_1_3(.A1 ({logic_0_263_net,
       ...
       logic_0_264_net}), .CE1 (n_86), .CE2 (clk), .CSB1
  ...
  SRAM2RW16x32 TAGS(.A1 ({logic_0_275_net, logic_0_274_net,
       ...
       (n_86), .CE2 (clk), .CSB1 (logic_0_280_net), .CSB2
       ...
       UNCONNECTED299}));
  INVx1_ASAP7_75t_SL g1062(.A (clk), .Y (n_86));
  DFFHQNx1_ASAP7_75t_L \memory_rw_ctr_reg[1]296 (.CLK (clk), .D (n_34),
       .QN (memory_rw_ctr[1]));
  A2O1A1Ixp33_ASAP7_75t_SL g1070__5122(.A1 (n_32), .A2
       (mem_resp_valid), .B (n_28), .C (n_38), .Y (n_34));
  DFFHQNx1_ASAP7_75t_L \memory_rw_ctr_reg[0]295 (.CLK (clk), .D (n_33),
       .QN (memory_rw_ctr[0]));
  A2O1A1Ixp33_ASAP7_75t_SL g1072__8246(.A1 (logic_0_348_net), .A2
       (n_24), .B (n_29), .C (n_38), .Y (n_33));
  DFFHQNx1_ASAP7_75t_L \state_reg[0] (.CLK (clk), .D (n_31), .QN
       (state[0]));
  DFFHQNx1_ASAP7_75t_L \state_reg[1] (.CLK (clk), .D (n_27), .QN
       (state[1]));
  DFFHQNx1_ASAP7_75t_L \state_reg[2] (.CLK (clk), .D (n_30), .QN
       (state[2]));
  DHLx1_ASAP7_75t_SL cpu_req_ready_reg304(.CLK (n_46), .D (n_26), .Q
       (cpu_req_fire));
  NAND2xp5_ASAP7_75t_SL g1078__7098(.A (nextstate[0]), .B (n_25), .Y
       (n_31));
  NAND2xp5_ASAP7_75t_SL g1079__6131(.A (nextstate[2]), .B (n_25), .Y
       (n_30));
  NOR2xp33_ASAP7_75t_SL g1080__1881(.A (logic_0_349_net), .B (n_24), .Y
       (n_29));
  NAND2xp5_ASAP7_75t_SL g1082__5115(.A (nextstate[1]), .B (n_25), .Y
       (n_27));
  INVx1_ASAP7_75t_SL g1083(.A (n_42), .Y (n_26));
  INVx1_ASAP7_75t_SL g1084(.A (reset), .Y (n_25));
  INVxp67_ASAP7_75t_SL g1085(.A (mem_resp_valid), .Y (n_24));
  DLLx1_ASAP7_75t_SL \dirty_bits_reg[0]308 (.CLK (n_23), .D (state[2]),
       .Q (dirty_bits[0]));
  OA21x2_ASAP7_75t_R g1074__7482(.A1 (n_22), .A2 (n_42), .B (n_43), .Y
       (n_23));
  INVx1_ASAP7_75t_SL g1231(.A (state[2]), .Y (n_22));
  NAND2xp33_ASAP7_75t_SL g1075__4733(.A (state[1]), .B (n_21), .Y
       (n_43));
  OR2x2_ASAP7_75t_SRAM g1232__6161(.A (state[1]), .B (state[0]), .Y
       (n_42));
  INVxp67_ASAP7_75t_SL g1077(.A (n_21), .Y (n_41));
  NOR2xp33_ASAP7_75t_SL g1233__9315(.A (state[0]), .B (state[2]), .Y
       (n_21));
  DHLx1_ASAP7_75t_SL \nextstate_reg[0] (.CLK (n_20), .D (n_19), .Q
       (nextstate[0]));
  DHLx2_ASAP7_75t_SL sram_mem_web_0_reg(.CLK (n_18), .D (n_17), .Q
       (sram_mem_web_0));
  DHLx1_ASAP7_75t_SL mem_req_data_valid_reg(.CLK (n_16), .D (state[1]),
       .Q (mem_req_data_valid));
  DHLx2_ASAP7_75t_SL sram_mem_web_1_reg(.CLK (n_18), .D (n_15), .Q
       (sram_mem_web_1));
  DHLx1_ASAP7_75t_SL \nextstate_reg[2] (.CLK (n_20), .D (n_14), .Q
       (nextstate[2]));
  DHLx1_ASAP7_75t_SL \nextstate_reg[1] (.CLK (n_20), .D (n_13), .Q
       (nextstate[1]));
  DHLx1_ASAP7_75t_SL tag_cpu_web_reg(.CLK (n_46), .D (n_12), .Q
       (tag_cpu_web));
  NAND4xp25_ASAP7_75t_R g1180__9945(.A (n_38), .B (n_11), .C (n_10), .D
       (mem_req_data_ready), .Y (n_20));
  OAI211xp5_ASAP7_75t_L g1171__2883(.A1 (n_9), .A2 (state[1]), .B
       (n_8), .C (n_7), .Y (n_19));
  OAI211xp5_ASAP7_75t_L g1178__2346(.A1 (n_45), .A2 (n_6), .B (n_44),
       .C (n_20), .Y (n_18));
  OR2x2_ASAP7_75t_SRAM g1219__1666(.A (n_43), .B (logic_0_351_net), .Y
       (n_17));
  OAI21xp33_ASAP7_75t_SL g1177__7410(.A1 (state[2]), .A2 (n_42), .B
       (n_20), .Y (n_16));
  NAND2xp33_ASAP7_75t_L g1218__6417(.A (n_5), .B (logic_0_350_net), .Y
       (n_15));
  AND2x2_ASAP7_75t_R g1221__5477(.A (n_42), .B (state[2]), .Y (n_14));
  OAI22xp33_ASAP7_75t_SL g1182__2398(.A1 (n_4), .A2 (n_44), .B1 (n_3),
       .B2 (n_12), .Y (n_13));
  INVx1_ASAP7_75t_SL g1227(.A (state[1]), .Y (n_12));
  INVxp67_ASAP7_75t_SL g1204(.A (n_7), .Y (n_11));
  INVx1_ASAP7_75t_SL g1226(.A (state[2]), .Y (n_10));
  AOI21xp33_ASAP7_75t_SL g1179__5107(.A1 (state[0]), .A2 (state[2]), .B
       (n_2), .Y (n_9));
  NAND2xp33_ASAP7_75t_L g1183__6260(.A (state[1]), .B (n_3), .Y (n_8));
  NAND2xp33_ASAP7_75t_SL g1224__4319(.A (state[0]), .B (state[1]), .Y
       (n_7));
  INVx1_ASAP7_75t_SL g1225(.A (mem_resp_valid), .Y (n_6));
  INVxp67_ASAP7_75t_SL g1228(.A (n_43), .Y (n_5));
  NOR2xp33_ASAP7_75t_SL g1220__8428(.A (logic_0_352_net), .B
       (state[0]), .Y (n_4));
  NOR2xp33_ASAP7_75t_L g1223__5526(.A (state[2]), .B (n_38), .Y (n_3));
  NOR3xp33_ASAP7_75t_SRAM g1181__6783(.A (n_1), .B (state[2]), .C
       (state[0]), .Y (n_2));
  NAND2xp33_ASAP7_75t_L g1222__3680(.A (logic_0_353_net), .B
       (logic_0_354_net), .Y (n_1));
  ...
  DHLx1_ASAP7_75t_SL mem_req_valid_reg(.CLK (n_46), .D (n_37), .Q
       (mem_req_valid));
  NAND2xp33_ASAP7_75t_SL g1069__1617(.A (n_44), .B (n_41), .Y (n_46));
  INVxp67_ASAP7_75t_SL g1234(.A (n_37), .Y (n_45));
  NOR2xp33_ASAP7_75t_SL g1071__2802(.A (n_0), .B (n_43), .Y (n_37));
  OR2x2_ASAP7_75t_SRAM g1235__1705(.A (state[2]), .B (state[1]), .Y
       (n_44));
  INVxp67_ASAP7_75t_SL g1073(.A (n_38), .Y (n_0));
  NAND2xp33_ASAP7_75t_L g1236__5122(.A (logic_0_355_net), .B
       (logic_0_356_net), .Y (n_38));
  HB1xp67_ASAP7_75t_SRAM g1237(.A (logic_0_357_net), .Y (n_32));
  HB1xp67_ASAP7_75t_SRAM g1238(.A (logic_0_358_net), .Y (n_28));
...
module cache(clk, reset, cpu_req_valid, cpu_req_ready, cpu_req_addr,
  ...
  DHLx1_ASAP7_75t_SL mem_req_valid_reg(.CLK (n_26), .D (n_18), .Q
       (mem_req_valid));
  AOI21xp33_ASAP7_75t_SL g872__8246(.A1 (mem_resp_valid), .A2 (n_17),
       .B (n_12), .Y (n_19));
  NOR2xp33_ASAP7_75t_SL g873__7098(.A (n_12), .B (n_24), .Y (n_18));
  INVx1_ASAP7_75t_SL g874(.A (n_17), .Y (n_24));
  DHLx1_ASAP7_75t_SL tag_cpu_web_reg(.CLK (n_26), .D (n_12), .Q
       (tag_cpu_web));
  NOR2xp33_ASAP7_75t_SL g876__6131(.A (n_14), .B (state[0]), .Y (n_17));
  OR3x1_ASAP7_75t_L g877__1881(.A (logic_0_637_net), .B (n_12), .C
       (state[0]), .Y (n_16));
  NAND3xp33_ASAP7_75t_R g878__5115(.A (logic_0_638_net), .B (n_13), .C
       (state[1]), .Y (n_15));
  DHLx1_ASAP7_75t_SL \cpu_req_addr_reg_reg[11] (.CLK (logic_0_636_net),
       .D (cpu_req_addr[11]), .Q (cpu_req_addr_reg[11]));
  INVxp67_ASAP7_75t_SL g880(.A (n_25), .Y (n_14));
  NAND2xp33_ASAP7_75t_L g881__7482(.A (logic_0_639_net), .B
       (logic_0_640_net), .Y (n_25));
  NAND2xp33_ASAP7_75t_SL g882__4733(.A (state[0]), .B (state[1]), .Y
       (n_26));
  INVxp67_ASAP7_75t_SL g883(.A (state[0]), .Y (n_13));
  INVx1_ASAP7_75t_SL g884(.A (clk), .Y (n_29));
  ...
  DFFHQNx1_ASAP7_75t_SL \state_reg[1] (.CLK (clk), .D (n_10), .QN
       (state[1]));
  A2O1A1Ixp33_ASAP7_75t_SL g879__6161(.A1 (n_6), .A2 (mem_resp_valid),
       .B (n_4), .C (n_25), .Y (n_11));
  DFFHQNx1_ASAP7_75t_L \memory_rw_ctr_reg[0]295 (.CLK (clk), .D (n_9),
       .QN (memory_rw_ctr[0]));
  A2O1A1Ixp33_ASAP7_75t_SL g886__9315(.A1 (n_25), .A2 (state[1]), .B
       (n_7), .C (n_1), .Y (n_10));
  DFFHQNx1_ASAP7_75t_SL \state_reg[0] (.CLK (clk), .D (n_8), .QN
       (state[0]));
  A2O1A1Ixp33_ASAP7_75t_SL g887__9945(.A1 (logic_0_641_net), .A2 (n_0),
       .B (n_5), .C (n_25), .Y (n_9));
  DHLx1_ASAP7_75t_SL cpu_req_ready_reg304(.CLK (n_26), .D (n_3), .Q
       (cpu_req_fire));
  NAND3xp33_ASAP7_75t_SL g888__2883(.A (n_1), .B (n_24), .C (state[1]),
       .Y (n_8));
  OA21x2_ASAP7_75t_SL g889__2346(.A1 (logic_0_642_net), .A2 (state[0]),
       .B (n_2), .Y (n_7));
  NOR2xp33_ASAP7_75t_SL g891__1666(.A (logic_0_643_net), .B (n_0), .Y
       (n_5));
  NOR2xp33_ASAP7_75t_SL g893__7410(.A (state[0]), .B (state[1]), .Y
       (n_3));
  INVx1_ASAP7_75t_L g894(.A (state[1]), .Y (n_2));
  INVx1_ASAP7_75t_SL g895(.A (reset), .Y (n_1));
  INVxp67_ASAP7_75t_SL g896(.A (mem_resp_valid), .Y (n_0));
  HB1xp67_ASAP7_75t_SRAM g897(.A (logic_0_644_net), .Y (n_6));
  HB1xp67_ASAP7_75t_SRAM g898(.A (logic_0_645_net), .Y (n_4));
  TIELOx1_ASAP7_75t_SL tie_0_cell(.L (cpu_req_ready));
